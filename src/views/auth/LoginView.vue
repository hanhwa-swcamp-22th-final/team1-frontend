...
const roles = [
  { id: 'sys',    name: '시스템 관리자', desc: '플랫폼 전체 사용자·업체 관리',            loginId: 'sys.admin@conk.com',     pw: '1234', note: '시스템 관리자 데모 계정' },
  { id: 'master', name: '총괄 관리자',   desc: '3PL 업체 운영, 셀러 회사·계정 관리',      loginId: 'master1.admin@conk.com', pw: '1234', note: '총괄 관리자 데모 계정' },
  { id: 'whm',    name: '창고 관리자',   desc: '창고 운영, 로케이션·재고·작업자 관리',    loginId: 'wh.manager@conk.com',    pw: '1234', note: '창고 관리자 데모 계정' },
  { id: 'worker', name: '창고 작업자',   desc: '작업 피킹·패킹·입고 처리 화면 확인',      loginId: 'WORKER-001',             pw: '1234', note: '작업자 코드로 로그인' },
  { id: 'seller', name: '셀러 담당자',   desc: '상품·ASN·주문·재고 알림 확인',           loginId: 'seller@conk.com',        pw: '1234', note: '셀러 담당자 데모 계정' },
]
